...
public class SkinLayoutInflaterFactory implements LayoutInflaterFactory {
    ...
    private static final String NAME_PLACE = "http://schemas.android.com/apk/res-auto";
...
//        获取是否应用换肤操作
        boolean hasApplySkin = attrs.getAttributeBooleanValue(NAME_PLACE, "applySkin",false);
